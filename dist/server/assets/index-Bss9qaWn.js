import { P as reactExports, H as jsxRuntimeExports } from "./server-BjeYpVtl.js";
...
const Brush = createLucideIcon("brush", __iconNode$t);
const __iconNode$s = [
...
const Flower2 = createLucideIcon("flower-2", __iconNode$l);
const __iconNode$k = [
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "glass shadow-soft py-3" : "py-5 bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container mx-auto px-5 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "flex items-center gap-2 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-gold grid place-items-center text-ink font-display font-bold", children: "T" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold text-foreground", children: "Texas Beauty" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.25em] text-gold", children: "Salon · Spring TX" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "container mx-auto px-5 py-6 flex flex-col gap-4", children: [
...
const heroImg = "/assets/home-hero-wlphSGvq.jpg";
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative min-h-screen flex items-center pt-28 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-luxe" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-gold/30 blur-3xl animate-float -z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-32 -left-32 w-[400px] h-[400px] rounded-full bg-blush/60 blur-3xl -z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "space-y-7",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-xs uppercase tracking-[0.25em] text-foreground/80", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3.5 h-3.5 text-gold" }),
              " Premium Salon · Spring, TX"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-6xl lg:text-7xl leading-[1.05] text-ink", children: [
              "Luxury Hair & Beauty ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold italic", children: "Experience" }),
              " in Texas"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 max-w-xl", children: "Professional hair styling, beauty treatments & premium salon care — crafted by master stylists in the heart of Spring, Texas." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 pt-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5 text-gold", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-current" }, i)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70", children: "Trusted by hundreds of clients" })
              ] })
            ] })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "relative",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] rounded-[2rem] overflow-hidden shadow-luxe", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: heroImg,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-gold grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-ink" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: "Always Open" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground/70", children: "24/7 booking available" })
                  ] })
                ] })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-foreground/60", children: "Since" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-gradient-gold", children: "Years of trust" })
                ]
              }
            )
          ]
...
const g7 = "/assets/salon-7-DQVE7QIZ.webp";
const g8 = "/assets/salon-1-azrvBX0p.webp";
const highlights = [
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 lg:py-32 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: g7, alt: "Salon lounge", className: "rounded-2xl aspect-[3/4] object-cover shadow-luxe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: g8,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 left-1/2 -translate-x-1/2 glass rounded-2xl px-6 py-4 shadow-luxe text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl text-gradient-gold", children: "100%" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-foreground/70", children: "Satisfaction" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.7 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-gold", children: "About Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 mb-5 text-ink", children: [
            "Where beauty meets ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "craftsmanship" }),
            "."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-4 leading-relaxed", children: "Texas Beauty Salon is Spring's premier destination for luxurious hair and beauty experiences. Our team of experienced beauty professionals brings together modern techniques, premium products, and a warm, welcoming atmosphere to deliver results you'll love." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-8 leading-relaxed", children: "From precision haircuts and dimensional color to keratin treatments and beauty care, every service is tailored to bring out your most confident self." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-4", children: highlights.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(h.icon, { className: "w-6 h-6 text-gold mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: h.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-1", children: h.text })
              ]
            },
            h.title
          )) })
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "py-24 lg:py-32 bg-gradient-to-b from-background to-muted/40 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 right-0 w-96 h-96 bg-blush/40 rounded-full blur-3xl -z-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-gold", children: "Our Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 text-ink", children: [
              "Curated services for your ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "signature look" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mt-4", children: "Every service is delivered with attention to detail, premium products, and a touch of Texan warmth." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-gold opacity-0 group-hover:opacity-5 transition-opacity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-gradient-luxe grid place-items-center mb-5 group-hover:scale-110 group-hover:rotate-3 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "w-7 h-7 text-ink" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-ink mb-2", children: s.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 leading-relaxed", children: s.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 text-xs uppercase tracking-widest text-gold opacity-0 group-hover:opacity-100 transition-opacity", children: "Book now →" })
          ]
        },
        s.title
      )) })
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "why", className: "py-24 lg:py-32 bg-ink text-primary-foreground relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_top_right,oklch(0.78_0.11_75/0.18),transparent_50%)]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "text-center max-w-2xl mx-auto mb-16",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-gold", children: "Why Choose Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 text-primary-foreground", children: [
              "A salon experience worth ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "coming back for" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-gold grid place-items-center mb-5 text-ink", children: /* @__PURE__ */ jsxRuntimeExports.jsx(f.icon, { className: "w-6 h-6" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl mb-2", children: f.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/65 leading-relaxed", children: f.desc })
          ]
        },
        f.title
      )) })
...
const g1 = "/assets/salon-9-Ddr9Pprn.webp";
const g2 = "/assets/salon-6-6iBKhMxT.webp";
const g3 = "/assets/salon-5-vsM8EkL2.webp";
const g4 = "/assets/salon-10-Di88zsWu.webp";
const g5 = "/assets/salon-4-qMGkPO22.webp";
const g6 = "/assets/salon-8-C23pjkfN.webp";
const items = [
...
function Gallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-gold", children: "Gallery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 text-ink", children: [
            "Step inside our ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "studio" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 auto-rows-[180px] md:auto-rows-[220px] gap-4", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, scale: 0.95 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary-foreground", children: it.alt }) })
        ]
      },
      i
    )) })
...
function Reviews() {
  ...
  reactExports.useEffect(() => {
    const t = setInterval(next, 6e3);
    return () => clearInterval(t);
  }, []);
  const r = reviews[i];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "reviews", className: "py-24 lg:py-32 bg-gradient-luxe relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-10 left-10 w-72 h-72 bg-gold/30 rounded-full blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "text-center max-w-2xl mx-auto mb-14",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-ink/70", children: "Testimonials" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 text-ink", children: [
              "Loved by our ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "clients" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "w-10 h-10 text-gold mx-auto mb-6" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl md:text-3xl text-ink leading-snug italic", children: [
                '"',
                r.text,
                '"'
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-col items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 text-gold", children: [...Array(5)].map((_, k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-current" }, k)) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mt-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: prev, className: "w-11 h-11 rounded-full glass grid place-items-center hover:bg-ink hover:text-primary-foreground transition", "aria-label": "Previous", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-4 h-4" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: next, className: "w-11 h-11 rounded-full glass grid place-items-center hover:bg-ink hover:text-primary-foreground transition", "aria-label": "Next", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4" }) })
        ] })
      ] })
    ] })
  ] });
...
function Contact() {
  ...
  const [form, setForm] = reactExports.useState({ name: "", email: "", phone: "", service: "", message: "" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        className: "text-center max-w-2xl mx-auto mb-14",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-gold", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl mt-3 text-ink", children: [
            "Book your ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-gradient-gold not-italic", children: "visit" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mt-4", children: "We'd love to pamper you. Reach out, send a message, or stop by — we're always open for bookings." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://maps.google.com/?q=4915+Farm+to+Market+2920+Spring+TX+77388", target: "_blank", rel: "noreferrer", className: "rounded-2xl p-5 bg-card border border-border hover:border-gold/50 hover:shadow-soft transition group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-6 h-6 text-gold mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: "Visit Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-1", children: "4915 Farm to Market 2920, Spring, TX 77388 (Marcin Plaza)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+18329225592", className: "rounded-2xl p-5 bg-card border border-border hover:border-gold/50 hover:shadow-soft transition", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6 text-gold mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: "Call Now" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-1", children: "+1 832-922-5592" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:bermillobeautysalon@outlook.com", className: "rounded-2xl p-5 bg-card border border-border hover:border-gold/50 hover:shadow-soft transition", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-6 h-6 text-gold mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-1 break-all", children: "bermillobeautysalon@outlook.com" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl p-5 bg-card border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6 text-gold mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-ink", children: "Hours" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-1", children: "Always Open · 24/7 booking" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden border border-border shadow-soft aspect-[4/3]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "iframe",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.form,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-ink mb-1", children: "Send us a message" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mb-6", children: "We typically respond via WhatsApp within minutes." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Name", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, value: form.name, onChange: (e) => setForm({ ...form, name: e.target.value }), maxLength: 80, className: "input" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Phone", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, type: "tel", value: form.phone, onChange: (e) => setForm({ ...form, phone: e.target.value }), maxLength: 30, className: "input" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Email", className: "sm:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, type: "email", value: form.email, onChange: (e) => setForm({ ...form, email: e.target.value }), maxLength: 120, className: "input" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Service", className: "sm:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.service, onChange: (e) => setForm({ ...form, service: e.target.value }), className: "input", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Choose a service…" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Haircut" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Hair Coloring" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Keratin Treatment" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Hair Styling" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Shampoo & Conditioning" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Hair Threading" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Manicure" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Beauty Treatment" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Message", className: "sm:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 4, maxLength: 600, value: form.message, onChange: (e) => setForm({ ...form, message: e.target.value }), className: "input resize-none" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
function Field({ label, children, className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: `block ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs uppercase tracking-widest text-ink/70 mb-2", children: label }),
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `.input { width: 100%; padding: 0.75rem 1rem; border-radius: 0.75rem; background: oklch(1 0 0 / 0.7); border: 1px solid oklch(0.2 0 0 / 0.08); color: var(--ink); outline: none; transition: all 0.2s; }
        .input:focus { border-color: var(--gold); box-shadow: 0 0 0 3px oklch(0.78 0.11 75 / 0.2); background: white; }` })
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-ink text-primary-foreground pt-16 pb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 grid md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-gold grid place-items-center text-ink font-display font-bold", children: "T" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl", children: "Texas Beauty Salon" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/65 max-w-sm leading-relaxed", children: "Luxury hair & beauty experiences in Spring, Texas. Crafted with care by passionate professionals." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "w-10 h-10 rounded-full border border-white/15 grid place-items-center hover:bg-gold hover:text-ink hover:border-gold transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "w-10 h-10 rounded-full border border-white/15 grid place-items-center hover:bg-gold hover:text-ink hover:border-gold transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { className: "w-4 h-4" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg mb-4", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm text-white/65", children: [["About", "#about"], ["Services", "#services"], ["Gallery", "#gallery"], ["Reviews", "#reviews"], ["Contact", "#contact"]].map(([l, h]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: h, className: "hover:text-gold transition", children: l }) }, h)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-white/65", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            ...
            " 4915 Farm to Market 2920, Spring, TX 77388"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 mt-0.5 text-gold shrink-0" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+18329225592", className: "hover:text-gold", children: "+1 832-922-5592" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 mt-0.5 text-gold shrink-0" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:bermillobeautysalon@outlook.com", className: "hover:text-gold break-all", children: "bermillobeautysalon@outlook.com" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-5 mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between gap-3 text-xs text-white/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Texas Beauty Salon. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Crafted with Easyweb in Sri Lanka." })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-6 h-6 relative" })
      ]
    }
  );
}
